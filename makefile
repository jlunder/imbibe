...
bitmap_objs = bitmap.obj bitmap_graphics.obj
bitmap_graphics_objs = $(bitmap_objs)
...
task_objs = task.obj task_manager.obj
#task_manager_objs = $(timer_objs) $(task_objs)
task_manager_objs = $(task_objs)
text_window_objs = text_window.obj $(bitmap_objs)
timed_task_objs = timed_task.obj $(task_objs) $(timer_objs)
fadein_task_objs = fadein_task.obj $(bitmap_objs) $(bitmap_element_objs) &
                   $(timed_task_objs)
fadeout_task_objs = fadeout_task.obj $(bitmap_objs) $(bitmap_element_objs) &
                    $(timed_task_objs)
key_dispatcher_task_objs = key_dispatcher_task.obj $(task_objs) &
                           $(task_manager_objs)
menu_objs = menu.obj $(bin_bitmap_objs)
key_handler_objs =
rectangle_element_objs = rectangle_element.obj $(element_objs)
stop_handler_objs = stop_handler.obj $(key_handler_objs) $(task_objs)
stop_task_objs = stop_task.obj $(task_objs)
...
hbin_element_objs = hbin_element.obj $(element_objs) $(graphics_objs) &
...
imbibe_objs = imbibe.obj $(bin_bitmap_objs) $(bitmap_objs) &
              ...
              $(fadein_task_objs) $(fadeout__objs) $(menu_element_objs) &
              $(task_objs) $(task_manager_objs) $(text_window_objs) &
              $(timed_task_objs) $(timer_objs)
...
test2_objs = test2.obj $(bin_bitmap_objs) $(bitmap_objs) &
             $(bitmap_element_objs) $(cstream_objs) $(timed_task_objs) &
             $(task_manager_objs) $(text_window_objs)
test2.exe: $(test2_objs)

test3_objs = test3.obj $(bin_bitmap_objs) $(cstream_objs) &
             $(key_dispatcher_task_objs) $(menu_objs) $(menu_element_objs) &
             $(menu_handler_objs) $(rectangle_element_objs) &
             $(stop_handler_objs) $(task_manager_objs) $(text_window_objs)
test3.exe: $(test3_objs)

test4_objs = test4.obj $(bin_bitmap_objs) $(cstream_objs) $(hbin_objs) &
             $(hbin_element_objs) $(hbin_menu_handler_objs) &
             $(key_dispatcher_task_objs) $(rectangle_element_objs) &
             $(stop_handler_objs) $(task_manager_objs) $(text_window_objs)
...
test5_objs = test5.obj $(cstream_objs) $(hbin_objs) &
             ...
             $(key_handler_objs) $(key_dispatcher_task_objs) &
...
keytest_objs = keytest.obj $(key_dispatcher_task_objs) $(key_handler_objs) &
               $(task_objs) $(task_manager_objs)
