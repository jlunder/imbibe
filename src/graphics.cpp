...
bool prepare_plain_tbm_transform_params(graphics &g, unpacker &tbm, coord_t x,
                                        coord_t y, coord_t width,
                                        coord_t height,
...
void draw_tbm(graphics &g, coord_t x, coord_t y, unpacker const &tbm_data,
              TLineOp op) {
...
void graphics::enter_subregion(subregion_state &save, coord_t x, coord_t y,
                               coord_t clip_x1, coord_t clip_y1,
...
void graphics::draw_tbm(coord_t x, coord_t y, unpacker const &tbm_data) {
  aux_graphics::draw_tbm(*this, x, y, tbm_data, aux_graphics::copy_line_op());
}
